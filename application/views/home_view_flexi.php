<link rel="stylesheet" href="<?=base_url();?>front/css/flexslider.css" type="text/css" media="screen" />
...
<section class="section-slider">
    ...
    <div class="flexslider">
        <ul class="slides">
            ...
            ?>
            <li><img src="<?=base_url();?>img/slider_folder/<?=$s->slider_image;?>" alt></li>
            <?php
            }
            ?>
        </ul>
...
<script defer src="<?=base_url();?>front/js/jquery.flexslider.js"></script>
