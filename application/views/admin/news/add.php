    ...
    <div class="page-content">            
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">                    
                ...
                <li>
                    <a href="#">Tambah Berita & Kegiatan</a>
                </li>
            </ul>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box red-thunderbird">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-plus-circle"></i> Form Tambah Berita & Kegiatan
                        </div>
                    </div>
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-icon right">
                                            <i class="fa"></i>
                                            <input type="text" class="form-control" name="name" placeholder="Input Nama Content" autocomplete="off" required autofocus />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-icon right">
                                            <i class="fa"></i>
                                            <textarea class="wysihtml5 form-control" rows="10" name="desc" required></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
...
$(document).ready(function() {
    ...
    $("#formInput").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                url: '<?php echo site_url('admin/news/savedata'); ?>',
                type: "POST",
                dataType: 'json',
                data: formData,
                async: true,
