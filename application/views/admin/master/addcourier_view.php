            ...
            <div class="col-md-12">
                ...
                <div class="portlet box red-thunderbird">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-plus-circle"></i> Tambah Data Kurir
                        </div>
                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-icon right"><i class="fa"></i>
                                            <input type="text" class="form-control" placeholder="Input Nama Jasa Kurir" name="name" id="name" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="wysihtml5 form-control" rows="10" name="desc"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">                    
...
$(document).ready(function() {
    ...
    $("#formInput").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                url: "<?php echo site_url('admin/courier/savedata'); ?>",
                type: "POST",
                data: dataString,
                dataType: 'JSON',
