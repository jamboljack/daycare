            ...
            <div class="col-md-12">
                ...
                <div class="portlet box red-thunderbird">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-edit"></i> Detail Informasi Toko
                        </div>
                    </div>
                        ...
                        <form role="form" class="form-horizontal" method="post" id="formInput" name="formInput">
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="wysihtml5 form-control" rows="10" name="desc"><?php echo $detail->setting_desc; ?></textarea>
                                    </div>
                                </div>
                            </div>
...
$(document).ready(function() {
    ...
    $("#formInput").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                url: "<?php echo site_url('admin/info/updatedata'); ?>",
                type: "POST",
                data: dataString,
