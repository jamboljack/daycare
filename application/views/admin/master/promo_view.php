...
<script>
    function hapusData(promo_id) {
        ...
        swal({
            ...
            if (!isConfirm) return;
            $.ajax({
                url : "<?php echo site_url('admin/promo/deletedata')?>/"+id,
                type: "POST",
                dataType: "JSON",
...
<div class="page-content-wrapper">
    <div class="page-content">            
        <h3 class="page-title">Gambar Promo</h3>
        <div class="page-bar">
            ...
            <div class="col-md-12">
                <div class="portlet box red-thunderbird">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-list"></i> Daftar Gambar Promo (Maksimal 2 Promo)
                        </div>
                    </div>
...
$(document).ready(function() {
    table = $('#tableData').DataTable({ 
        ...
        "order": [],
        "ajax": {
            "url": "<?php echo site_url('admin/promo/data_list')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 
...
$(document).ready(function() {
    ...
    $("#formInput").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                url: '<?php echo site_url('admin/promo/savedata'); ?>',
                type: "POST",
                dataType: 'json',
                data: formData,
                async: true,
...
function edit_data(id) {
    ...
    $.ajax({
        url : "<?php echo site_url('admin/promo/get_data/'); ?>"+id,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
...
$(document).ready(function() {
    ...
    $("#formEdit").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                url: '<?php echo site_url('admin/promo/updatedata'); ?>',
                type: "POST",
                dataType: 'json',
                data: formData,
                async: true,
